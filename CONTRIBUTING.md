# Contributing to Pebble-LSM

Thank you for your interest in contributing to Pebble-LSM! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/pebble-lsm.git
   cd pebble-lsm
   ```
...
Pebble-LSM is built on **Java 21 LTS** using Apache Maven.
